...
This repository publishes the official **Stream Kit** distribution for the **TTS** plugin (`tts`).
...
1. Download `plugin-tts.zip` from the [latest release](https://github.com/stream-kit-app/plugin-tts/releases/latest).
